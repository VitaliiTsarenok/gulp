...
gulp.task('watch', function() {
    ...
    gulp.watch(path.watch.htmlTemplate, gulp.series('html:build', 'reload'));
    gulp.watch(path.watch.css, gulp.series('css:build', 'reload'));
    gulp.watch(path.watch.scss, gulp.series('scss:build' , 'reload'));
    ...
    gulp.watch(path.watch.jsmain, gulp.series('jsmain:build', 'reload'));
});
